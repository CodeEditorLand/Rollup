	...
	implements DeoptimizableEntity
{
	...
	deoptimizeArgumentsOnInteractionAtPath(
		...
		this.consequent.deoptimizeArgumentsOnInteractionAtPath(
			interaction,
			path,
			recursionTracker,
		);
		this.alternate.deoptimizeArgumentsOnInteractionAtPath(
			interaction,
			path,
			recursionTracker,
		);
	...
	hasEffectsOnInteractionAtPath(
		...
		if (!usedBranch) {
			return (
				this.consequent.hasEffectsOnInteractionAtPath(
					path,
					interaction,
					context,
				) ||
				this.alternate.hasEffectsOnInteractionAtPath(
					path,
					interaction,
					context,
				)
