...
export function logAddonNotGenerated(
	message: string,
	hook: string,
	plugin: string,
): RollupLog {
...
export function logAssetReferenceIdNotFoundForSetSource(
...
export function logCircularReexport(
	exportName: string,
	exporter: string,
): RollupLog {
	return {
...
export function logCyclicCrossChunkReexport(
	...
	return {
		...
		message: `Export "${exportName}" of module "${relativeId(
			...
			preserveModules
				? 'do not use "output.preserveModules"'
				: 'reconfigure "output.manualChunks"'
...
export function logExternalSyntheticExports(
	id: string,
	importer: string,
): RollupLog {
	return {
...
export function logFileReferenceIdNotFoundForFilename(
	assetReferenceId: string,
): RollupLog {
	return {
		code: FILE_NOT_FOUND,
...
export function logIllegalImportReassignment(
	name: string,
	importingId: string,
): RollupLog {
	return {
...
export function logInternalIdCannotBeExternal(
	source: string,
	importer: string,
): RollupLog {
	return {
...
export function logInvalidAddonPluginHook(
	hook: string,
	plugin: string,
): RollupLog {
	return {
...
export function logInvalidFunctionPluginHook(
	hook: string,
	plugin: string,
): RollupLog {
	return {
...
export function logMissingGlobalName(
	externalId: string,
	guess: string,
): RollupLog {
	return {
...
export function logMixedExport(
...
export function logModuleLevelDirective(
	directive: string,
	id: string,
): RollupLog {
	return {
...
export function logNoTransformMapOrAstWithoutCode(
	pluginName: string,
): RollupLog {
	return {
...
export function logExternalModulesCannotBeIncludedInManualChunks(
	source: string,
): RollupLog {
	return {
...
export function logExternalModulesCannotBeTransformedToModules(
	source: string,
): RollupLog {
	return {
...
export function logUnresolvedImport(
	source: string,
	importer: string,
): RollupLog {
	return {
...
export function logUnresolvedImportTreatedAsExternal(
	source: string,
	importer: string,
): RollupLog {
	return {
