...
export const INTEROP_NAMESPACE_DEFAULT_ONLY_VARIABLE =
...
export const isDefaultAProperty = (
	...
	(externalLiveBindings &&
		(interopType === "auto" || interopType === "compat"));
...
const createNamespaceObject = (
	...
	const copyProperty =
		`{${n}` +
		(liveBindings
			? copyNonDefaultOwnPropertyLiveBinding
			: copyPropertyStatic)(t, index + t + t, snippets) +
		`${index}${t}}`;
	return (
...
export function getToStringTagValue(
	getObject: GenerateCodeSnippets["getObject"],
) {
