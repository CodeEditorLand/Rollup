...
function getCommandOptions(
	...
	const external =
		rawCommandOptions.external &&
		typeof rawCommandOptions.external === "string"
...
function mergeInputOptions(
	...
	const getOption = (name: keyof InputOptions): any =>
	...
	const inputOptions: CompleteInputOptions<keyof InputOptions> = {
		...
		makeAbsoluteExternalsRelative: getOption(
...
const getObjectOption = <T extends object>(
	...
	const configOption = normalizeObjectOptionValue(
		config[name],
		objectifyValue,
	);
