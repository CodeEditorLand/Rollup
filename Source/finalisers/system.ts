		...
		if (imports) {
			for (const specifier of imports) {
				...
				if (specifier.imported === "*") {
					...
					setter.push(
						`${specifier.local}${_}=${_}module${getPropertyAccess(specifier.imported)};`,
					);
				}
			}
		}
